...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        db.push(`isimler_${member.id}`, ` \`${name} | ${age}\` (<@&810631127902453781>)`);
        ...
        message.channel.send(embed2.setDescription(`${member} adlı kullanıcı\`${name} | ${age}\` isminde  kayıt edildi! (<@&810631127902453781>)`)
